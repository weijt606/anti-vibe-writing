...
- 新增"套路化开头 / 收尾 + 对比骨架"痕迹(中文轨之前没覆盖的):"在这个 XX 的时代,我们每个人都……""记住,真正重要的是……"开头、"以前……现在……"时间对比、"总之 / 归根结底 / 说到底"收尾,以及鸡汤 / 口号升华和"什么都对但什么都没说"的圆滑结论;同步进改写提示词块和确定性 grep。已覆盖的(不是…而是、值得注意的是、让我们开头、每段加小标题)不重复堆叠
